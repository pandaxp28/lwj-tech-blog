...
module ZzzCompanySiteBrandingV2
  ABOUT_PATHS = [
    '_tabs/about.md',
    '/_tabs/about.md',
    'about.md',
  ...
  ABOUT_CONTENT = <<~MARKDOWN
    ...
    - [LWJ ソフトウェア紹介ページ](http://www.lwj.co.jp/pc/software/index.html)
    - [GitHub: pandaxp28](https://github.com/pandaxp28)
  ...
  def self.apply_site_config(site)
    ...
    social['name'] = 'LWJ'
    social['links'] = ['http://www.lwj.co.jp/pc/software/index.html', 'https://github.com/pandaxp28']
...
Jekyll::Hooks.register :site, :after_init do |site|
  ZzzCompanySiteBrandingV2.apply_site_config(site)
end

[:pages, :documents].each do |scope|
  Jekyll::Hooks.register scope, :pre_render do |doc|
    next unless ZzzCompanySiteBrandingV2.about_page?(doc)

    doc.content = ZzzCompanySiteBrandingV2::ABOUT_CONTENT
  end
end
